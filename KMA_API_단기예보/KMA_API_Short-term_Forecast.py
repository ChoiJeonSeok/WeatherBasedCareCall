...
class WeatherDataFetcher:
    ...
    def fetch_data_for_location_and_time(self, base_date, base_time, nx, ny, custom_file_name=None, num_rows=1000,
                                         page_range=1):
        params = {
...
# 데이터 가져오기
fetcher.fetch_data_for_location_and_time('20231012', '0500', '37', '126')

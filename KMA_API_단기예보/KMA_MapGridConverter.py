...
class MapGridConverter:
    ...
    def grid_to_map(self, x, y, code=1):
        x = x - 1
        y = y - 1
        xn = x - self.xo
...
"""
from KMA_MapGridConverter import *

# 객체 생성
converter = MapGridConverter()

# 메서드 사용 예시
print(converter.map_to_grid(35.38192205231515, 126.49008871975882))
print(converter.grid_to_map(52, 79))
"""
